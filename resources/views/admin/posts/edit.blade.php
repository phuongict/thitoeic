                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-8" style="padding-bottom:120px">
                            <div class="form-group">
                                ...
                                <input id="title" type="text"
                                       ...
                                       value="@isset($request->title){{ $request->title }}@else{{ $objItem->title }}@endisset" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="content2"
                                          ...
                                          name="content2" rows="5">@isset($request->content2){{ $request->content2 }}@else{{ $objItem->content }}@endisset</textarea>
                        ...
                        <div class="col-lg-4" style="padding-bottom:120px">
                                ...
                                <select class="selectpicker" name="category_id" data-style="select-with-transition"
                                    ...
                                    @foreach($list_categorys as $category)
                                        @isset($request->category_id)
                                            ...
                                            @endif
                                            @else
                                                @if($objItem->category_id == $category->id)
                                                <option value="{{ $category->id }}" selected>{{ $category->name }}</option>
                                            @else
                                                <option value="{{ $category->id }}">{{ $category->name }}</option>
                                            @endif
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="@isset($request->tags){{ $request->tags }}@else{{ $objItem->tags }}@endisset" class="form-control tagsinput" data-role="tagsinput"
                            ...
                            <div class="form-group">
                                ...
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        <img src="@if($objItem->image==null){{ asset('/public/admin/assets/img/image_placeholder.jpg') }}@else{{ asset('/public/front/images/posts/'.$objItem->image) }}@endif" alt="...">
                                    </div>
