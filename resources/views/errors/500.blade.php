...
<div class="col-md-12">
    <div class="owl-background">
        <div class="moon"><div class="left">4</div><div class="right">3</div></div>
        <div class="owl">
            <div class="wing1"></div>
            <div class="wing2"></div>
            <div class="wing3"></div>
...
<div class="col-md-12">
    <div class="message">
        ...
        <p>Xin lỗi, tài khoản của bạn chưa được cấp quyền sử dụng chức năng này.
            <br>Bạn vui lòng liên hệ với Quản trị để được cấp quyền sử dụng
        </p>
