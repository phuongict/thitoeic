...
<head>
    ...
    <link href="{{ asset('/public/admin/assets/css/material-dashboard.css') }}" rel="stylesheet" />
    <!--  CSS for Demo Purpose, don't include it in your project     -->
    <link href="{{ asset('/public/admin/assets/css/demo.css') }}" rel="stylesheet" />
    <!--     Fonts and icons     -->
    <link href="{{ asset('/public/admin/assets/css/font-awesome.css') }}" rel="stylesheet" />
    <link href="{{ asset('/public/admin/assets/css/google-roboto-300-700.css') }}" rel="stylesheet" />
    <style>
